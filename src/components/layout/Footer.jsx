        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <div className="text-white font-bold text-lg leading-tight">Humedaxive Pharma</div>
                <div className="text-gray-400 text-xs">Trusted Healthcare Solutions</div>
              </div>
            </div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex gap-3">
                ...
                <div className="text-sm text-gray-400 space-y-1">
                  <a href="tel:+91 98521 03407" className="block hover:text-white transition-colors">+91 98521 03407</a>
                  <a href="tel:+918877060059" className="block hover:text-white transition-colors">+91 88770 60059</a>
                </div>
              </li>
              <li>
                <Link
                  to="/enquiry"
                  className="inline-flex items-center gap-2 text-sm bg-brand-teal text-white px-4 py-2 rounded-md hover:bg-brand-teal-dark transition-colors font-medium"
                >
      ...
      <div className="border-t border-gray-800">
        <div className="container-max px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-xs text-gray-500">
            &copy; {new Date().getFullYear()} Humedaxive Pharma. All rights reserved.
          </p>
